...
function actionPush(m1, m2) {
  $('#cart').text(m1); // заменяем элемент id="cart" на текст при потощи метода text
  $('#orders_input').val(m2); // обращаемся к полю формы через его айди и вставляем в его значение(value)
}
