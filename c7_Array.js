...
console.log(elements.reverse()); //=> ["Первый", true, 0, 6, 23]  перевернуть массив
...
console.log([140000, 104, 99].sort(function (a, b) {  return a - b;  })); //=> [99, 104, 140000]
console.log([140000, 104, 99].sort((a, b) => a - b); //=> [99, 104, 140000]
