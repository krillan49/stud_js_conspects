...
// JavaScript не поддерживает перегрузку операторов, а только методов. Самое близкое к нему что возможно сделать, это реализовать toString и valueOf. Эти примеры не демонстрируют перегрузку операторов, а просто используют преимущества встроенной обработки преобразования JavaScript в примитивы:
