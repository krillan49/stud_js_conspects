...
// Числа JavaScript имеют достаточно места для хранения только для представления целых чисел размером 53 бита. Это означает, что любое целое число меньше -2^53 и любое целое число больше 2^53 может быть округлено неправильно. Например:
...
// Bigint - математические операции с простым int невозможны, нужно все переводить Bigint
1n //=> 1 в типе Bigint
BigInt(1); //=> 1n
...
// Перевод из 2ичной в BigInt
BigInt('0b' + '1011011') //=> 91n
