...
//                                        Установка Node.js и Yarn на Линукс

// Node.js и Yarn (в Ubuntu)
// Обновить индекс пакета. Это поможет устанавливать последние версии, доступные в репозиториях.
// $ sudo apt update
// Установить Node.js. Yarn требует наличия Node.js в системе. Если его ещё нет, можно сделать это с помощью команды:
// $ sudo apt install nodejs
// Yarn недоступен в репозиториях Ubuntu по умолчанию, поэтому вам необходимо добавить репозиторий Yarn в вашу систему.
...
// (Ubuntu) Обновление Node.js через репозиторий NodeSource - имеются ввиду основные версии, тк минорные обновляются и так. Например, вместо версии 16.x поставить 20.х. Маловероятно, что Ubuntu предоставит крупное обновление новой версии до Node. Вот почему вы должны установить Node непосредственно из официальных репозиториев Nodesource.
// Node предоставляет скрипт для каждой активной основной версии. Нужно заменить YY на нужную версию в "curl -fsSL https://deb.nodesource.com/setup_YY.x | sudo -E bash -", Это заменит исходный файл на другой с нужной версией. Например обновить до версии 21:
