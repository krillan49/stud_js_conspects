...
// 1. match() - ищет подстроки соответсвующие регулярному выражению и выводит в видн массива. Когда результатов больше одного и/или задан флаг "g", выходные данные содержат все совпадающие подстроки; Если результат один и нет флага "g", выходные данные содержат совпадающую подстроку, ее индекс и исходную строку. Если результата совпадения нет, вывод будет null.
