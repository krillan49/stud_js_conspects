...
// Регулярное выражение не соотв ничему(тут символ после конца строки)
/$a/
...
// Вы можете использовать regex.sourceдля получения строкового представления регулярного выражения.
let regex = /abc|def|ghi/
console.log(regex.source); //=> "abc|def|ghi"
...
'abc'.replace(/(a)(b)(c)/, (a,b,c) => c+'0'+a+'1'+b+'2') //=> 'b0abc1a2'  // элементы группировки в отдельных переменных
