...
// метод Object RegExp: test(). Он используется для проверки того, соответствует ли строка объекту RegExp. Он возвращает логическое значение: true/false. Не применяет флаг g
/a/.test("abc");  //=> true
/ab/.test("abc");  //=> true
/ac/.test("abc");  //=> false
